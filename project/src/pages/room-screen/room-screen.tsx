...
import { AppRoute, AuthorizationStatus, compareByDate, sortOffers } from '../../const';
import CommentSubmissionForm from '../../components/comment-submission-form/comment-submission-form';
import { getAuthorizationStatus } from '../../store/user-process/user-process.selectors';
import { getNearbyOffers, getOffer, getOffers, getReviews, isDataLoading } from '../../store/main-data/main-data.selectors';
...
function RoomScreen(): JSX.Element | null {
  ...
  useEffect(() => {
    if (id) {
      ...
      const isOfferLoading = useAppSelector(isDataLoading);//TODO:дописать
