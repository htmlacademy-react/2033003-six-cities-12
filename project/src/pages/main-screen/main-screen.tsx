      ...
      <div className="cities">
        <div className={`cities__places-container container ${filteredOffers.length > 0 ? 'cities__places-container--empty' : ''}`}>
          {filteredOffers.length > 0 ?
            <section className="cities__places places">
              ...
              <div className="cities__places-list places__list tabs__content">
                <Offers offers={filteredOffers} setActiveOffer={setActiveOffer}/>
              </div>
            </section> :
          ...
          <div className="cities__right-section">
            {city ?
              <Map city={city} activeOfferId={activeOfferId} offers={filteredOffers} wrapperClassName={'cities__map'}/> :
