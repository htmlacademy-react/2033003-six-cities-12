...
function MainScreen() : JSX.Element {
  ...
  return(
    <div className={`page page--gray page--main ${offers.length === 0 ? 'page--main-empty' : ''}`}>
        ...
        <div className={`cities__places-container container ${offers.length > 0 ? 'cities__places-container--empty' : ''}`}>
          {offers.length > 0 ?
            <section className="cities__places places">
              ...
              <b className="places__found">{offers.length} places to stay in {selectedCityName}</b>
              <SortingOptions/>
          ...
          <div className="cities__right-section">
            {city ?
              <Map city={city} activeOfferId={activeOfferId} offers={offers} wrapperClassName={'cities__map'}/> :
